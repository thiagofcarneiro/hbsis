      ...
      *============================================================================= 		   
	   ...
	   01 TELA-01-MENU.
          ...
          02 LINE 07 COL 22 VALUE "01.02 - Cadastro de Vendedor                   ".         
	       ...
	       02 LINE 09 COL 22 VALUE "02.01 - RelatOrio de Clientes           ".
	       02 LINE 10 COL 22 VALUE "02.02 - RelatOrio de Vendedores  	 ".	  
	       02 LINE 11 COL 22 VALUE "Executar          ".	  
	       02 LINE 12 COL 22 VALUE "03.01 - Executar Distrib. de Clientes       ".                  
...
C55FB696 44B12436 C65564B1 448C20DF 72E797D9
          
          
          
          
		  
       01 TELA-03-RELATORIO.
          02 LINE 1 COL 1 REVERSE-VIDEO VALUE "Prova Cobol". 
      ...
      *============================================================================= 	
       2000-PROCESSA   				SECTION.
       	  ...
       	  INITIALIZE 			 	WORK-OPCAO-MENU
 
	        DISPLAY  TELA-01-MENU
	        ACCEPT   WORK-OPCAO-MENU     AT 1447 WITH UPPER
                                    AUTO-SKIP HIGHLIGHT.
            IF ESC
                     exit perform;
            END-IF
      ...
      *============================================================================= 	
       2000-CADASTROS             		SECTION.
	        ...
	        DISPLAY TELA-02-CADASTROS
	        DISPLAY "CADASTROS"     	AT 1623
          
       
	        DISPLAY  TELA-LIMPA
	        ACCEPT   WORK-OPCAO-CAD       AT 1447 WITH UPPER
                                        AUTO-SKIP HIGHLIGHT.   
            IF ESC
                   exit perform;
            END-IF
            
            EVALUATE WORK-OPCAO-CAD
               WHEN 01
      ...
      *============================================================================= 	
       2110-CAD-INCLUSAO             SECTION.
			...
			IF WORK-OPCAO-MENU-POS2 > 1 THEN
            DISPLAY TELA-02-CAD-VEND-INC
			ELSE
            DISPLAY TELA-02-CAD-CLI-INC
		   END-IF
         
         ACCEPT W-REG-COD       AT 1534
         ACCEPT W-REG-CNPJ-CPF  AT 1634
         ACCEPT W-REG-NOME      AT 1734
